    ...
    <div id="footer" class="cl">
        ...
        <div class="widget-2 last widget">
             ...
             <p>
              ...
              <p>Powered by <a href="http://www.taiaiwan.com" target="_blank">泰爱玩</a> <!--{if !empty($_G['setting']['boardlicensed'])}--> <a href="http://license.comsenz.com/?pid=1&host=$_SERVER[HTTP_HOST]" target="_blank">Licensed</a><!--{/if}--> 
