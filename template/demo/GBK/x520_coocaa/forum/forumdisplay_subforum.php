...
<div class="bm bmw fl{if $_G['forum']['forumcolumns']} flg{/if}">
	<div class="bm_h cl">
		<span class="o"><img id="subforum_{$_G[forum][fid]}_img" src="$_G['style']['styleimgdir']/img/collapsed_no.gif" title="{lang spread}" alt="{lang spread}" onclick="toggle_collapse('subforum_$_G['forum'][fid]');" /></span>
