...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<title><!--{if !empty($navtitle)}-->$navtitle - <!--{/if}--><!--{if empty($nobbname)}--> $_G['setting']['bbname'] - <!--{/if}--> Powered by PHPChina</title>
$_G['setting']['seohead']
	...
	<meta name="generator" content="PHPChina $_G['setting']['version']" />
	<meta name="author" content="PHPChina Team and Comsenz UI Team" />
	<meta name="copyright" content="2001-2013 PHPChina." />
    ...
    <script type="text/javascript" src="{$_G[setting][jspath]}jquery-1.8.3.min.js?{VERHASH}"></script>
	<link rel="stylesheet" href="{$_G[style][tpldir]}/common/Font-Awesome-master/css/font-awesome.min.css" />
