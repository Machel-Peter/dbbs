...
function s_showsetting($setname, $varname, $value, $type = 'radio', $disabled = '', $hidden = 0, $comment = '', $extra = '', $setid = '') {
	...
	if(!isset($_G['showsetting_multi'])) {
		$faqurl = 'http'.($_G['isHTTPS'] ? 's' : '').'://addon.1314study.com/faq.php?type=admin&ver='.$_G['setting']['version'].'&pid='.rawurlencode($plugin['identifier']).'&pname='.rawurlencode($plugin['name']).'&pver='.rawurlencode($plugin['version']).'&operation='.rawurlencode($_GET['operation']).'&key='.rawurlencode($setname);
...
function splugin_thinks($identifier, $show = '1'){
	...
	if(splugin_cloudaddon('&mod=app&ac=validator&addonid='.$addonid.($array !== false ? '&rid='.$array['RevisionID'].'&sn='.$array['SN'].'&rd='.$array['RevisionDateline'] : '')) === '0') {
			...
			echo "&#x611F;&#x8C22;&#x4F7F;&#x7528;13"."14&#x5B"."66;&#x4"."E60;&#x"."7F51;&#x7684;&#x63D2;&#x4EF6;&#xFF0C;&#x767E;&#x5EA6;&#x641C;&#x7D22; 1314&#x5E94;&#x7528;&#x4E2D;&#x5FC3; &#x83B7;&#x53D6;&#x66F4;&#x591A;&#x5E94;&#x7528;&#x3002;<div style='display:none'>\n2018051514ay1XD8ul1G\n21187\n1521874801\nhttp://dis-bbs.com/\nhttp://dis-bbs.com/\n928DDC2E-8D1E-F8CE-C578-608F841BAB35\n5C90B79B-50B1-9B0F-6DF1-A7DDE69F6211</div>";
	}
}
...
function splugin_cloudaddon($extra, $post = '') {
	return dfsockopen(cloudaddons_url('&from=s').$extra, 0, $post, '', false, CLOUDADDONS_DOWNLOAD_IP, 5);
}
...
function s_addon_stat($plugin,$action){
	...
	$_statInfo['SiteUrl'] = 'http://dis-bbs.com/';
	$_statInfo['ClientUrl'] = 'http://dis-bbs.com/';
	$_statInfo['SiteID'] = '928DDC2E-8D1E-F8CE-C578-608F841BAB35';
	...
	cpmsg('<p style="font-size:20px;margin-bottom:10px;">&#x9875;&#x9762;&#x52A0;&#x8F7D;&#x4E2D;&#xFF0C;&#x8BF7;&#x7A0D;&#x7B49;...</p><p><img src="static/image/admincp/ajax_loader.gif" width="150" height="13"/></p><script type="text/javascript">location.href="htt'.'p'.($_G['isHTTPS'] ? 's' : '').'://addon.1314'.'stu'.'dy.com/st'.'at.php'.$_StatUrl.'";</script>', '', 'succeed');
}
...
function s_shownav($header = '', $menu = '', $nav = '') {
	...
	$cpurl = str_replace('%26identifier%3Daddon_seo_rewrite', '', cpurl());
	...
	$dtitle = str_replace("'", "\'", diconv(base64_decode('44CQMTMxNOWtpuS5oOe9keOAkeaPkuS7tuiuvue9riAtIOS9v+eUqOmXrumimOivt+WIsDEzMTTlrabkuaDnvZHvvIh3d3cuMTMxNHN0dWR5LmNvbe+8ieWPjemmiA=='), 'utf-8', CHARSET));
