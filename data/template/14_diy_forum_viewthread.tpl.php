...
0
|| checktplrefresh('./template/rabbit_2018/forum/viewthread.htm', './template/default/forum/viewthread_node.htm', 1528787741, 'diy', './data/template/14_diy_forum_viewthread.tpl.php', './template/rabbit_2018', 'forum/viewthread')
|| checktplrefresh('./template/rabbit_2018/forum/viewthread.htm', './template/rabbit_2018/forum/viewthread_fastpost.htm', 1528787741, 'diy', './data/template/14_diy_forum_viewthread.tpl.php', './template/rabbit_2018', 'forum/viewthread')
|| checktplrefresh('./template/rabbit_2018/forum/viewthread.htm', './template/default/forum/viewthread_node_body.htm', 1528787741, 'diy', './data/template/14_diy_forum_viewthread.tpl.php', './template/rabbit_2018', 'forum/viewthread')
|| checktplrefresh('./template/rabbit_2018/forum/viewthread.htm', './template/default/common/seditor.htm', 1528787741, 'diy', './data/template/14_diy_forum_viewthread.tpl.php', './template/rabbit_2018', 'forum/viewthread')
|| checktplrefresh('./template/rabbit_2018/forum/viewthread.htm', './template/default/forum/seccheck_post.htm', 1528787741, 'diy', './data/template/14_diy_forum_viewthread.tpl.php', './template/rabbit_2018', 'forum/viewthread')
|| checktplrefresh('./template/rabbit_2018/forum/viewthread.htm', './template/default/common/upload.htm', 1528787741, 'diy', './data/template/14_diy_forum_viewthread.tpl.php', './template/rabbit_2018', 'forum/viewthread')
|| checktplrefresh('./template/rabbit_2018/forum/viewthread.htm', './template/default/common/seccheck.htm', 1528787741, 'diy', './data/template/14_diy_forum_viewthread.tpl.php', './template/rabbit_2018', 'forum/viewthread')
...
<?php } } else { if(!$_G['forum_thread']['is_archived']) { ?><a id="newspecial" onmouseover="$('newspecial').id = 'newspecialtmp';this.id = 'newspecial';showMenu({'ctrlid':this.id})"<?php if(!$_G['forum']['allowspecialonly'] && empty($_G['forum']['picstyle']) && !$_G['forum']['threadsorts']['required']) { ?> onclick="showWindow('newthread', 'forum.php?mod=post&action=newthread&fid=<?php echo $_G['fid'];?>')"<?php } else { ?> onclick="location.href='forum.php?mod=post&action=newthread&fid=<?php echo $_G['fid'];?>';return false;"<?php } ?> href="javascript:;" title="发新帖">发新帖</a><?php } } if($allowpostreply && !$_G['forum_thread']['archiveid']) { ?>
<a id="post_reply" onclick="showWindow('reply', 'forum.php?mod=post&action=reply&fid=<?php echo $_G['fid'];?>&tid=<?php echo $_G['tid'];?>')" href="javascript:;" title="回复">回复</a>
<?php } ?>
...
<?php } } if($_G['setting']['threadhidethreshold'] && $_G['forum_thread']['hidden'] >= $_G['setting']['threadhidethreshold']) { if($_G['forum_thread']['authorid'] == $_G['uid']) { ?><a class="psave" id="hiderecover" title="点击恢复主题隐藏状态" href="forum.php?mod=misc&amp;action=hiderecover&amp;tid=<?php echo $_G['tid'];?>&amp;formhash=<?php echo FORMHASH;?>" onclick="showWindow(this.id, this.href, 'get', 0);">隐藏</a><?php } else { ?>(隐藏)<?php } ?>
&nbsp;
...
<?php if($modmenu['thread']) { ?>
<div id="modmenu" class="xi2 mbm pbm bbs">
...
<a id="newspecialtmp" onmouseover="$('newspecial').id = 'newspecialtmp';this.id = 'newspecial';showMenu({'ctrlid':this.id})"<?php if(!$_G['forum']['allowspecialonly'] && empty($_G['forum']['picstyle']) && !$_G['forum']['threadsorts']['required']) { ?> onclick="showWindow('newthread', 'forum.php?mod=post&action=newthread&fid=<?php echo $_G['fid'];?>')"<?php } else { ?> onclick="location.href='forum.php?mod=post&action=newthread&fid=<?php echo $_G['fid'];?>';return false;"<?php } ?> href="javascript:;" title="发新帖">发新帖</a>
<?php } if($allowpostreply && !$_G['forum_thread']['archiveid']) { ?>
<a id="post_replytmp" onclick="showWindow('reply', 'forum.php?mod=post&action=reply&fid=<?php echo $_G['fid'];?>&tid=<?php echo $_G['tid'];?>')" href="javascript:;" title="回复">回复</a>
<?php } ?>
</div>
...
<div id="f_pst" class="pl<?php if(empty($_GET['from'])) { ?> bm <?php } ?>">
...
<div class="avatar avtm"><a href="javascript:;" onclick="showWindow('login', 'member.php?mod=logging&action=login')"><?php echo avatar(0,middle);?></a></div></td>
<?php } else { ?>
<td class="pls rabbit_fastpost">
<div class="rabbit_fastpost_name"><?php echo $_G['username'];?></div>
