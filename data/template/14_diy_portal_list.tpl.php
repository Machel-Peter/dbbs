<?php if(!defined('IN_DISCUZ')) exit('Access Denied'); hookscriptoutput('list');?><?php include template('common/header'); ?><!--[name]!portalcategory_listtplname![/name]--><?php $list = array();?><?php $wheresql = category_get_wheresql($cat);?><?php $list = category_get_list($cat, $wheresql, $page);?><?php var_dump($list);?><div id="pt" class="bm cl">
<div class="z">
...
<?php if($cat['subs']) { ?>
<div class="bm_c bbda">
下级分类:&nbsp;&nbsp;<?php $i = 1;?><?php if(is_array($cat['subs'])) foreach($cat['subs'] as $value) { if($i != 0) { ?><span class="pipe">|</span><?php } ?><a href="<?php echo $portalcategory[$value['catid']]['caturl'];?>" class="xi2"><?php echo $value['catname'];?></a><?php $i--;?><?php } ?>
</div>
<?php } ?>
