...
0
|| checktplrefresh('./template/wdao_works_free/common/header.htm', './template/wdao_works_free/common/header_common.htm', 1527848781, '13', './data/template/9_13_common_header_forum_viewthread.tpl.php', './template/wdao_works_free', 'common/header_forum_viewthread')
|| checktplrefresh('./template/wdao_works_free/common/header.htm', './template/default/common/header_qmenu.htm', 1527848781, '13', './data/template/9_13_common_header_forum_viewthread.tpl.php', './template/wdao_works_free', 'common/header_forum_viewthread')
|| checktplrefresh('./template/wdao_works_free/common/header.htm', './template/wdao_works_free/common/wdao_search.htm', 1527848781, '13', './data/template/9_13_common_header_forum_viewthread.tpl.php', './template/wdao_works_free', 'common/header_forum_viewthread')
;?>
...
<base href="<?php echo $_G['siteurl'];?>" /><link rel="stylesheet" type="text/css" href="data/cache/style_9_common.css?<?php echo VERHASH;?>" /><link rel="stylesheet" type="text/css" href="data/cache/style_9_forum_viewthread.css?<?php echo VERHASH;?>" /><?php if($_G['uid'] && isset($_G['cookie']['extstyle']) && strpos($_G['cookie']['extstyle'], TPLDIR) !== false) { ?><link rel="stylesheet" id="css_extstyle" type="text/css" href="<?php echo $_G['cookie']['extstyle'];?>/style.css" /><?php } elseif($_G['style']['defaultextstyle']) { ?><link rel="stylesheet" id="css_extstyle" type="text/css" href="<?php echo $_G['style']['defaultextstyle'];?>/style.css" /><?php } ?><!--[if lt IE 9]>
<script src="<?php echo $_G['style']['styleimgdir'];?>/js/html5shiv.min.js" type="text/javascript" type="text/javascript"></script>
<script src="<?php echo $_G['style']['styleimgdir'];?>/js/respond.min.js" type="text/javascript" type="text/javascript"></script>
<![endif]-->
<script src="<?php echo $_G['style']['styleimgdir'];?>/js/jquery.js" type="text/javascript"></script>
<script src="<?php echo $_G['style']['styleimgdir'];?>/js/wdao_core.js" type="text/javascript"></script>
...
<div class="wdao_wp">
<div class="wdao_logo"><?php $mnid = getcurrentnav();?> <h2><?php if(!isset($_G['setting']['navlogos'][$mnid])) { ?><a href="<?php if($_G['setting']['domain']['app']['default']) { ?>http://<?php echo $_G['setting']['domain']['app']['default'];?>/<?php } else { ?>./<?php } ?>" title="<?php echo $_G['setting']['bbname'];?>"><?php echo $_G['style']['boardlogo'];?></a><?php } else { ?><?php echo $_G['setting']['navlogos'][$mnid];?><?php } ?></h2>
</div>
<div class="menu" style="height:56px;margin:0 auto;float:left">
...
<div class="wdao_usercenter y">
<?php if(!empty($_G['setting']['pluginhooks']['global_nav_extra'])) echo $_G['setting']['pluginhooks']['global_nav_extra'];?><?php include template('common/header_userstatus'); ?></div>
<span class="wdao-search">
<a href="javascript:" class="search-show" style="display: inline;"><i></i></a>
<a href="javascript:" class="search-off" style="display: none;"><i></i></a></span>

</div>

</div>
<div class="site-search">
<div style="width:1200px;margin:0 auto"><?php $slist = array();?><?php if($_G['fid'] && $_G['forum']['status'] != 3 && $mod != 'group') { ?><?php
$slist[forumfid] = <<<EOF
...
<form id="scbar_form" class="site-search-form" method="<?php if($_G['fid'] && !empty($searchparams['url'])) { ?>get<?php } else { ?>post<?php } ?>" autocomplete="off" onsubmit="searchFocus($('scbar_txt'))" action="<?php if($_G['fid'] && !empty($searchparams['url'])) { ?><?php echo $searchparams['url'];?><?php } else { ?>search.php?searchsubmit=yes<?php } ?>" target="_blank">
...
<?php } ?>
   <div class="mf-input cl">
        <input type="text" class="search-input xg1 xg1" name="srchtxt" id="scbar_txt" value="请输入搜索内容" autocomplete="off" x-webkit-speech="" speech="">
        <span class="wdao_scbar_type"><a href="javascript:;" id="scbar_type" class="xg1 showmenu" onclick="showMenu(this.id)" hidefocus="true">搜索</a></span>
        </div>
        <button type="submit" name="searchsubmit" id="scbar_btn" sc="1" class="search-btn button-primary" value="true">搜索</button>		

</form>
</div>
<ul id="scbar_type_menu" class="p_pop wdao_scbar_type_menu" style="display: none;"><?php echo implode('', $slist);; ?></ul>
...
<?php } ?>
<div class="wdao_subnav"> <?php echo $_G['setting']['menunavs'];?> </div><?php echo adshow("headerbanner/wp a_h");?><?php if(!empty($_G['setting']['pluginhooks']['global_header'])) echo $_G['setting']['pluginhooks']['global_header'];?>
<?php } ?>
