...
0
|| checktplrefresh('./template/default/portal/view.htm', './template/default/portal/portal_comment.htm', 1528166198, 'diy', './data/template/14_diy_portal_view.tpl.php', './template/wic_random', 'portal/view')
|| checktplrefresh('./template/default/portal/view.htm', './template/default/common/seccheck.htm', 1528166198, 'diy', './data/template/14_diy_portal_view.tpl.php', './template/wic_random', 'portal/view')
