...
0
|| checktplrefresh('./template/wdao_works_free/common/header_w.htm', './template/wdao_works_free/common/header_common.htm', 1527844902, '13', './data/template/9_13_common_header_w.tpl.php', './template/wdao_works_free', 'common/header_w')
|| checktplrefresh('./template/wdao_works_free/common/header_w.htm', './template/default/common/header_qmenu.htm', 1527844902, '13', './data/template/9_13_common_header_w.tpl.php', './template/wdao_works_free', 'common/header_w')
|| checktplrefresh('./template/wdao_works_free/common/header_w.htm', './template/wdao_works_free/common/wdao_search.htm', 1527844902, '13', './data/template/9_13_common_header_w.tpl.php', './template/wdao_works_free', 'common/header_w')
;?>
