...
0
|| checktplrefresh('./template/wdao_works_free/common/header.htm', './template/wdao_works_free/common/header_common.htm', 1527839440, '13', './data/template/9_13_common_header_forum_index.tpl.php', './template/wdao_works_free', 'common/header_forum_index')
|| checktplrefresh('./template/wdao_works_free/common/header.htm', './template/default/common/header_qmenu.htm', 1527839440, '13', './data/template/9_13_common_header_forum_index.tpl.php', './template/wdao_works_free', 'common/header_forum_index')
|| checktplrefresh('./template/wdao_works_free/common/header.htm', './template/wdao_works_free/common/wdao_search.htm', 1527839440, '13', './data/template/9_13_common_header_forum_index.tpl.php', './template/wdao_works_free', 'common/header_forum_index')
;?>
