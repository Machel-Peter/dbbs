...
0
|| checktplrefresh('./template/rabbit_2018/common/header.htm', './template/default/common/header_common.htm', 1528787734, '18', './data/template/14_18_common_header_forum_forumdisplay.tpl.php', './template/rabbit_2018', 'common/header_forum_forumdisplay')
|| checktplrefresh('./template/rabbit_2018/common/header.htm', './template/rabbit_2018/common/pubsearchform.htm', 1528787734, '18', './data/template/14_18_common_header_forum_forumdisplay.tpl.php', './template/rabbit_2018', 'common/header_forum_forumdisplay')
;?>
...
<title><?php if(!empty($navtitle)) { ?><?php echo $navtitle;?> - <?php } if(empty($nobbname)) { ?> <?php echo $_G['setting']['bbname'];?> - <?php } ?> Powered by Peter!</title>
...
">
<ul class="cony_qqul">
<ol>&#x7FA4;&#x540D;:Discuz!&#x7AD9;&#x957F;&#x4E92;&#x52A9;&#x7FA4;</ol>
<ol>&#x7FA4;&#x53F7;:652692981</ol>
<ol>&#x7B80;&#x4ECB;: &#x4E3A;&#x60A8;&#x89E3;&#x51B3;&#x5728;&#x5EFA;&#x7AD9;&#x4E2D;&#x4EA7;&#x751F;&#x7684;&#x95EE;&#x9898;</ol>
...
</style><?php $mnid = getcurrentnav();?><h2><?php if(!isset($_G['setting']['navlogos'][$mnid])) { ?><a href="<?php if($_G['setting']['domain']['app']['default']) { ?>http://<?php echo $_G['setting']['domain']['app']['default'];?>/<?php } else { ?>./<?php } ?>" title="<?php echo $_G['setting']['bbname'];?>"><div class="cony_logo"style="height: 45px;"><?php echo $_G['style']['boardlogo'];?></div></a><?php } else { ?><?php echo $_G['setting']['navlogos'][$mnid];?><?php } ?></h2>
<div id="nv">
...
<?php if($_G['uid']) { if($_G['member']['newprompt']) { ?>
<div class="cony_repoat"title="&#x60A8;&#x6709;&#x65B0;&#x7684;&#x63D0;&#x9192;&#x7B49;&#x5F85;&#x67E5;&#x770B;"></div>
<?php } elseif($_G['member']['newpm']) { ?>
<div class="cony_repoat"title="&#x60A8;&#x6709;&#x65B0;&#x7684;&#x6D88;&#x606F;&#x7B49;&#x5F85;&#x67E5;&#x770B;"></div>
<?php } $newmane = $_G[username];?><?php $lgname = strlen($newmane) > 6 ? substr($newmane,0,6).'..':$newmane;?><a href="home.php?mod=space&amp;uid=<?php echo $_G['uid'];?>"><img src="uc_server/avatar.php?uid=<?php echo $_G['uid'];?>&amp;size=small" style="width: 20px;border-radius: 100px;margin-top: 7px;margin-left: -3px;padding: 3px;background: #FFF;border: 1px solid #DEDEDE;"></a><i style="letter-spacing: 1px;margin-top: 3px;position: absolute;margin-left: -6px;width:110px;">Hi~<?php echo $lgname;?><small>&#9660;</small>
...
<a href="home.php?mod=space&amp;do=notice&amp;view=system"><li><?php if($_G['member']['newprompt']) { ?><font color="red">&#x6536;&#x5230;&#x65B0;&#x7684;&#x63D0;&#x9192;</font><?php } else { ?>&#x7AD9;&#x5185;&#x63D0;&#x9192;<?php } ?></li></a>
<a href="home.php?mod=space&amp;do=pm"><li><?php if($_G['member']['newpm']) { ?><font color="red">&#x6536;&#x5230;&#x65B0;&#x7684;&#x77ED;&#x4FE1;</font><?php } else { ?>&#x77ED;&#x4FE1;&#x6D88;&#x606F;<?php } ?></li></a>
<?php if($_G['uid'] && getstatus($_G['member']['allowadmincp'], 1)) { ?><a href="admin.php"target="_blank"><li>&#x7BA1;&#x7406;&#x4E2D;&#x5FC3;</li></a><?php } if(($_G['group']['allowmanagearticle'] || $_G['group']['allowpostarticle'] || $_G['group']['allowdiy'] || getstatus($_G['member']['allowadmincp'], 4) || getstatus($_G['member']['allowadmincp'], 6) || getstatus($_G['member']['allowadmincp'], 2) || getstatus($_G['member']['allowadmincp'], 3))) { ?>
<a href="portal.php?mod=portalcp"><li><?php if($_G['setting']['portalstatus'] ) { ?>门户管理<?php } else { ?>模块管理<?php } ?></li></a><?php } ?>
...
<a href="member.php?mod=logging&amp;action=logout&amp;formhash=<?php echo FORMHASH;?>"><li style="border-top: 1px solid #DDD;background: #F2F2F2;color: #FF0000;">&#x9000;&#x51FA;&#x767B;&#x5165;</li></a>
</ul>
</i>
<?php } else { ?>
