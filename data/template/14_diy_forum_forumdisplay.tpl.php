...
0
|| checktplrefresh('./template/rabbit_2018/forum/forumdisplay.htm', './template/default/forum/forumdisplay_leftside.htm', 1528787734, 'diy', './data/template/14_diy_forum_forumdisplay.tpl.php', './template/rabbit_2018', 'forum/forumdisplay')
|| checktplrefresh('./template/rabbit_2018/forum/forumdisplay.htm', './template/default/forum/recommend.htm', 1528787734, 'diy', './data/template/14_diy_forum_forumdisplay.tpl.php', './template/rabbit_2018', 'forum/forumdisplay')
|| checktplrefresh('./template/rabbit_2018/forum/forumdisplay.htm', './template/default/common/seccheck.htm', 1528787734, 'diy', './data/template/14_diy_forum_forumdisplay.tpl.php', './template/rabbit_2018', 'forum/forumdisplay')
|| checktplrefresh('./template/rabbit_2018/forum/forumdisplay.htm', './template/rabbit_2018/forum/forumdisplay_list.htm', 1528787734, 'diy', './data/template/14_diy_forum_forumdisplay.tpl.php', './template/rabbit_2018', 'forum/forumdisplay')
|| checktplrefresh('./template/rabbit_2018/forum/forumdisplay.htm', './template/default/forum/forumdisplay_sort.htm', 1528787734, 'diy', './data/template/14_diy_forum_forumdisplay.tpl.php', './template/rabbit_2018', 'forum/forumdisplay')
|| checktplrefresh('./template/rabbit_2018/forum/forumdisplay.htm', './template/default/forum/search_sortoption.htm', 1528787734, 'diy', './data/template/14_diy_forum_forumdisplay.tpl.php', './template/rabbit_2018', 'forum/forumdisplay')
|| checktplrefresh('./template/rabbit_2018/forum/forumdisplay.htm', './template/default/forum/search_sortoption.htm', 1528787734, 'diy', './data/template/14_diy_forum_forumdisplay.tpl.php', './template/rabbit_2018', 'forum/forumdisplay')
...
<div class="boardnav">
<div id="ct" class="wp cl<?php if($_G['forum']['allowside']) { ?> ct2<?php } ?>"<?php if($leftside) { ?> <?php } ?>>
<?php if($leftside) { ?>
<div id="sd_bdl" class="bdl" onmouseover="showMenu({'ctrlid':this.id, 'pos':'dz'});" style="width:120px">
...
<div class="mn"<?php if($leftside) { ?>style="float:right;width:1060px;"<?php } ?>>
...
<?php if(!$_GET['archiveid']) { ?><a href="javascript:;" id="newspecial" onmouseover="$('newspecial').id = 'newspecialtmp';this.id = 'newspecial';showMenu({'ctrlid':this.id})"<?php if(!$_G['forum']['allowspecialonly'] && empty($_G['forum']['picstyle']) && !$_G['forum']['threadsorts']['required']) { ?> onclick="showWindow('newthread', 'forum.php?mod=post&action=newthread&fid=<?php echo $_G['fid'];?>')"<?php } else { ?> onclick="location.href='forum.php?mod=post&action=newthread&fid=<?php echo $_G['fid'];?>';return false;"<?php } ?> title="发新帖">发新帖</a><?php } ?>
...
<?php if(empty($_G['forum']['sortmode'])) { ?><style>
.xi2, .xi2 a, .xi3 a {
...
<tr>
<th style="border-bottom:none !important;"colspan="<?php if(!$_GET['archiveid'] && $_G['forum']['ismoderator']) { ?>3<?php } else { ?>2<?php } ?>">
...
<table summary="forum_<?php echo $_G['fid'];?>" cellspacing="0" cellpadding="0" id="threadlisttableid"<?php if($leftside) { ?>style="width:1058px !important;"<?php } ?>>
...
<tbody id="separatorline" class="emptb"style="display:none;"><tr><td class="icn"></td><?php if(!$_GET['archiveid'] && $_G['forum']['ismoderator']) { ?><td class="o"></td><?php } ?><th></th><?php if(CURMODULE == 'guide') { ?><td class="by"></td><?php } ?><td class="by"></td><td class="num"></td><td class="by"></td></tr></tbody>
...
<?php } ?>
<td class="by">
<?php if(!empty($_G['setting']['pluginhooks']['forumdisplay_author'][$key])) echo $_G['setting']['pluginhooks']['forumdisplay_author'][$key];?><?php $sipath="uc_server/avatar.php?uid=$thread[authorid]&amp;size=small";?><style>td.author { width: 150px; text-align: left; }</style><div style="float:left;width:28px;padding-top:4px;"><a href="home.php?mod=space&amp;uid=<?php echo $thread['authorid'];?>" c="1"><img src="<?php echo $sipath;?>" class="ava_border" width="25px" height="25px" style="border:1px solid #ccc; padding:2px; margin:0px; background-color:#fff;" /></a>
</div>
<div style="float:left;padding:6px 0px 0px 6px;">
...
<td class="num"><a href="forum.php?mod=viewthread&amp;tid=<?php echo $thread['tid'];?>&amp;extra=<?php echo $extra;?>"><?php echo $thread['allreplies'];?></a>/<?php if($thread['isgroup'] != 1) { ?><?php echo $thread['views'];?><?php } else { ?><?php echo $groupnames[$thread['tid']]['views'];?><?php } ?></td>
<td class="by">
